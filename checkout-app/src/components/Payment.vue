  ...
  <div class="col-span-1 lg:col-span-6">
    ...
    <div class="p-10 rounded-md shadow-md bg-white">
      ...
      <div class="mb-6">
        ...
        <input type="text" :id="fields.cardName" v-letter-only @input="changeName" :value="formData.cardName" data-card-field autocomplete="off" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-wider" />
      </div>
      <div class="mb-6">
      ...
      <div class="mb-6 flex flex-wrap -mx-3w-full">
        <div class="w-2/3 px-3">
          ...
          <div class="flex">
            <select class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest mr-6" :id="fields.cardMonth" v-model="formData.cardMonth" @change="changeMonth" data-card-field>
            ...
            <select class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest" :id="fields.cardYear" v-model="formData.cardYear" @change="changeYear" data-card-field>
        ...
        <div class="w-1/3 px-3">
          ...
          <input type="tel" v-number-only :id="fields.cardCvv" maxlength="4" :value="formData.cardCvv" @input="changeCvv" data-card-field autocomplete="off" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest" />
        </div>
      </div>
      ...
      <div>
        <button @click="finishPayment" class="w-full text-ceenter px-4 py-3 bg-blue-500 rounded-md shadow-md text-white font-semibold">Confirm payment</button>
      </div>
    </div>
  </div>
</template>
